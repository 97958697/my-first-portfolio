...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-8615c7b#zoc4(zd@51^k#o@&4ljld6+tcpps$_(mm2w9x5ze!^')
...
STATICFILES_DIRS = [
    # Root static (PythonAnywhere の ~/portfolio/static)
...
# Deploy staticfiles with WhiteNoise
